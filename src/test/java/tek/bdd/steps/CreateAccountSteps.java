...
public class CreateAccountSteps extends SeleniumUtility {
    ...
    public void fillUpCreateAccountForm() {
        ...
        sendText(CreateAccountPageObject.FIRST_NAME_INPUT, "Zubaida");
        sendText(CreateAccountPageObject.LAST_NAME_INPUT, "Malikzay");
    ...
    public void whenTheUserFillUpSignUpForm() {
        sendText(CreateAccountPageObject.USERNAME_INPUT, "Zubaida");
        sendText(CreateAccountPageObject.PASSWORD_INPUT, "zubaida123$");
        sendText(CreateAccountPageObject.CONFIRM_PASSWORD_INPUT, "zubaida123");
    }
    ...
    public void fillUpCreateAccountFormPage() {
        ...
        sendText(CreateAccountPageObject.EMAIL_INPUT, "zubaida422@gmail.com");
        selectFromDropDown(CreateAccountPageObject.PREFIX_SELECT, "Mrs.");
        sendText(CreateAccountPageObject.FIRST_NAME_INPUT, "Zubaida");
        sendText(CreateAccountPageObject.LAST_NAME_INPUT, "Malikzay");
        selectFromDropDown(CreateAccountPageObject.GENDER_SELECT, "Female");
